...
class DuplicateVar(Command):
    ...
    """
    def __init__(self, p_name, p_global, p_prio=1):
        """
            p_name:   una cadena que es el nombre de la variable a duplicar.
            p_global: un 'boolean' que dice si la variable a duplicar es global
                      o no.
    ...
    def get_global(self):
        """
            ...
            Retorna 'True' si la variable a duplicar es global, 'False'
            en otro caso.
        """
    ...
    def execute(self, p_conn):
        ...
        names = {self.__name: [1, self.__global]}
        cmd = ""
